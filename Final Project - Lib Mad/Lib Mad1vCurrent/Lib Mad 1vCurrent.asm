...
storyTime proc
    ...
    print ". What a wild guy! ",40,"And what a bunch of " 
    invoke StdOut, ADDR inputAdjective

    print " sots they are!",41,13,10,9
    print "I wish there were "
    invoke StdOut, ADDR inputNumber
    
    print " more of him!",13,10,"The world could always use more "
    invoke StdOut, ADDR inputName
    
    print "s! A guy like that really wants to make you say '"
